...
@ObjectClassDefinition(//
		...
		description = "Implements an OCPP capable standard electric vehicle charging station without the smart charging function")
@interface Config {
	...
	@AttributeDefinition(name = "EVCS logical identifier", description = "The logical id defined in the web administration interface of the EVCS chargepoint.", required = true)
	String logicalId() default "evse100";

	@AttributeDefinition(name = "EVCS limit identifier", description = "The limit id defined in the web administration interface of the EVCS chargepoint.", required = true)
	...
	String webconsole_configurationFactory_nameHint() default "EVCS OCPP Standard [{id}]";
}