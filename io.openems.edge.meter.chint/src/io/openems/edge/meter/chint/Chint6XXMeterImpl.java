...
@Component(//
		name = "io.openems.edge.meter.chint", //
		immediate = true, //
		configurationPolicy = ConfigurationPolicy.REQUIRE //
)
public class Chint6XXMeterImpl extends AbstractOpenemsModbusComponent 
    implements Chint6XXMeter, SymmetricMeter, AsymmetricMeter, ModbusComponent, OpenemsComponent, ModbusSlave  {
